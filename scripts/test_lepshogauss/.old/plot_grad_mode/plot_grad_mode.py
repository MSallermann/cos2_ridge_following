...
settings = plot_surface.PlotSettings(
    ...
    plot_gradient=plot_surface.VectorPlotSettings(
        color="blue",
        streamplot=False,
        quiver=True,
        kwargs=dict(scale=20),
        sampling=1,
        label="Gradient",
    ),
    plot_mode=plot_surface.VectorPlotSettings(
        color="red",
        streamplot=False,
        quiver=True,
        kwargs=dict(scale=20),
...
if __name__ == "__main__":
    ...
    L = [
        np.array(
            [
                [1.0497508613264181, 1.0640660677370612],
                [-1.0358282254699618, -0.9328841117058126],
            ]
        ),
